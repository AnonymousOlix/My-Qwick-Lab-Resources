...
echo -e "${BOLD_CYAN}║                                                      ║${RESET}"
echo -e "${BOLD_CYAN}║   ${BOLD_YELLOW}Welcome to My Qwiklab cloud tutorial ${BOLD_CYAN}           ║${RESET}"
echo -e "${BOLD_CYAN}║                                                      ║${RESET}"
echo -e "${BOLD_CYAN}╚══════════════════════════════════════════════════════╝${RESET}"
echo ""
...
echo -e "${RED_TEXT}${BOLD_TEXT}Subscribe Creative Jv:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@MyQwiklab${RESET_FORMAT}"
echo
